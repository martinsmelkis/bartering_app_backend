package org.barter.features.federation.dao

import kotlinx.serialization.encodeToString
import kotlinx.serialization.json.Json
import org.barter.extensions.DatabaseFactory.dbQuery
import org.barter.features.federation.db.FederatedUsersTable
import org.barter.features.federation.model.FederatedUser
import org.barter.features.federation.model.FederatedUserProfile
        ...
        val federatedProfiles = userProfiles.map { profile ->
            FederatedUserProfile(
                ...
                location = if (profile.latitude != null && profile.longitude != null) {
                    org.barter.features.federation.model.FederatedLocation(
                ...
                lastOnline = try {
                    if (org.barter.features.profile.cache.UserActivityCache.isOnline(profile.userId)) {
                        Instant.now()
                    } else null
                } catch (e: Exception) {
                    null
