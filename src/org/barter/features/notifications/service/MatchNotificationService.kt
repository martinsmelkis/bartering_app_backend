        ...
        return try {
            withContext(Dispatchers.IO) {
                newSuspendedTransaction(Dispatchers.IO) {
                    ...
                    val embedding1 = org.barter.features.postings.db.UserPostingsTable
                        .select(org.barter.features.postings.db.UserPostingsTable.embedding)
                        .where { org.barter.features.postings.db.UserPostingsTable.id eq postingId1 }
                        .singleOrNull()
                        ?.get(org.barter.features.postings.db.UserPostingsTable.embedding)

                    val embedding2 = org.barter.features.postings.db.UserPostingsTable
                        .select(org.barter.features.postings.db.UserPostingsTable.embedding)
                        .where { org.barter.features.postings.db.UserPostingsTable.id eq postingId2 }
                        .singleOrNull()
                        ?.get(org.barter.features.postings.db.UserPostingsTable.embedding)
