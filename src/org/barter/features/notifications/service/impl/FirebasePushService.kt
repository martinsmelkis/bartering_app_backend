...
class FirebasePushService : PushNotificationService {
    ...
    private fun buildAndroidConfig(notification: PushNotification): AndroidConfig {
        val priority = when (notification.priority) {
            org.barter.features.notifications.model.NotificationPriority.HIGH -> AndroidConfig.Priority.HIGH
            org.barter.features.notifications.model.NotificationPriority.NORMAL -> AndroidConfig.Priority.NORMAL
            org.barter.features.notifications.model.NotificationPriority.LOW -> AndroidConfig.Priority.NORMAL
        }
