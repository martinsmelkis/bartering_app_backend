...
private val sensitiveAuditRules = listOf(
    ...
    SensitiveAuditRule(HttpMethod.Post, Regex("^/api/v1/profile-info$"), "SENSITIVE_PROFILE_READ_ACCESS", "user_profile", "gdpr_accountability"),
    SensitiveAuditRule(HttpMethod.Post, Regex("^/api/v1/profile-info-extended$"), "SENSITIVE_PROFILE_READ_ACCESS", "user_profile", "gdpr_accountability"),
