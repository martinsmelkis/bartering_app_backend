    ...
    suspend fun execute() {
        ...
        DatabaseFactory.dbQuery {
            ...
            val coreProfileKeywords = listOf(
                "Nature, outdoors, gardening, animals, environment, hiking, plants, sustainability, wildlife, ecology, forests, mountains, camping, fishing, farming, conservation, organic, natural, green living, eco-friendly, botanical, outdoor adventure, wilderness, backpacking, greenhouse, seeds, trails, recycling, upcycling, flowers, herbs",
                ...
                "Technology, gaming, video games, multiplayer, e-sports, gaming PC, console gaming, learning, education, innovation, brainstorming, ideas, science, podcasts, software, programming, coding, digital, tech, computing, engineering, research and development, courses, tutorials, knowledge sharing, problem-solving, inventions, STEM, scripting, data, automation, artificial intelligence, software development, Python, Java, Kotlin, JavaScript, Web development, mobile apps, gadgets, electronics, computers, hardware, smartphones, routers, networking, wifi, game development, streaming"
            )
